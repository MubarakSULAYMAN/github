        ...
        <div class="main-menu flex-row">
            <div class="menu-links flex-row">
                ...
                >
                    ...
                    {{ route.name }}
                    <span class="repo-count" v-if="index === 1"> 98 </span>
                </router-link>
            </div>
...
.top-nav a.router-link-exact-active.router-link-active {
    display: flex;
    width: fit-content;
...
.top-nav a.router-link-exact-active.router-link-active:hover {
