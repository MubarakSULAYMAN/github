            ...
            <div class="details-wrapper grid">
                <div class="repo-summary">
                    <router-link to="">
                        ...
                        <span class="follower">{{ user_info.followers }}</span>
                        followers
                    </router-link>
                    ·
                    <router-link to="">
                        <span class="following">{{ user_info.following }}</span>
                        following
                    </router-link>
                    ·
                    <router-link to="">
                        ...
                        <span class="star">{{ starred_repos.length }}</span>
                    </router-link>
                </div>
